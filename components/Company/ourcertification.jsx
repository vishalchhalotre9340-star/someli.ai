...
import styles from './ourcertification.module.css';

export default function OurCertification() {
  // Reusable SVG definitions identical to the ones in the image
  
  const FlowerLogoipsum = (
    <svg className={styles.logo} viewBox="0 0 160 40" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      <g transform="translate(10, 3) scale(0.85)">
        <circle cx="20" cy="20" r="16" fill="none" stroke="currentColor" strokeWidth="1.5"/>
        <circle cx="20" cy="11" r="8" fill="none" stroke="currentColor" strokeWidth="1.5"/>
        <circle cx="20" cy="29" r="8" fill="none" stroke="currentColor" strokeWidth="1.5"/>
        <circle cx="11" cy="20" r="8" fill="none" stroke="currentColor" strokeWidth="1.5"/>
        <circle cx="29" cy="20" r="8" fill="none" stroke="currentColor" strokeWidth="1.5"/>
      </g>
      <text x="50" y="27" fontSize="22" fontWeight="400" fontFamily="sans-serif">Logoipsum</text>
      <circle cx="158" cy="12" r="2" />
    </svg>
  );
  ...
  const DiamondLogo = (
    <svg className={styles.logo} viewBox="0 0 140 40" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M30 15h60" stroke="#111111" strokeWidth="6"/>
      <path d="M20 25h60" stroke="#111111" strokeWidth="6"/>
    </svg>
  );
  ...
  const TribalSpiky = (
    <svg className={styles.logo} viewBox="0 0 120 40" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M10 20l10-7.5 10 7.5-10 7.5L10 20zm40 0l10-7.5 10 7.5-10 7.5L50 20z" fill="#111111"/>
    </svg>
  );
  ...
  // Array of logos corresponding exactly to the grid layout in the screenshot
  const logos = [
    FlowerLogoipsum,
    DiamondLogo,
    WideLogoipsum,
  ...
  return (
    <section className={styles.section}>
      <span className={styles.badge}>Our Certifications</span>
