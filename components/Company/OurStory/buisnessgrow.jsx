...
import styles from './buisnessgrow.module.css';

export default function BusinessGrow() {
  return (
    <section className={styles.section}>
      <h3 className={styles.title}>Businesses that grow with Someli</h3>
          ...
          {[1, 2, 3].map((setIndex) => (
            <React.Fragment key={setIndex}>
              ...
              <svg className={styles.logo} viewBox="0 0 140 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M30 15h60" stroke="#121212" strokeWidth="6"/>
                <path d="M20 25h60" stroke="#121212" strokeWidth="6"/>
              </svg>
              ...
              <svg className={styles.logo} viewBox="0 0 120 40" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M10 20l10-7.5 10 7.5-10 7.5L10 20zm40 0l10-7.5 10 7.5-10 7.5L50 20z" fill="#121212"/>
              </svg>
            </React.Fragment>
          ))}
        </div>
